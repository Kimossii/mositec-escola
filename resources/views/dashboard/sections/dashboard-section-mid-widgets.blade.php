        ...
        <div class="row gx-9 h-100">
            ...
            <div class="col-sm-6 mb-10 mb-sm-0">
                ...
                <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-400px min-h-sm-100 h-100"
                    style="background-size: 100% 100%;background-image:url('{{asset('themes/metronic/assets/media/stock/600x600/img-65.jpg')}}')">
                </div>
                <!--end::Image-->
            </div>
            <!--end::Col-->
                    ...
                    <div class="d-flex flex-stack mt-auto bd-highlight">
                        ...
                        <div class="symbol-group symbol-hover flex-nowrap">
                                                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy">
                                                                            <img alt="Pic" src="{{asset('themes/metronic/assets/media/avatars/300-2.jpg')}}" />
                                                                    </div>
                                                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
                                                                            <img alt="Pic" src="{{asset('themes/metronic/assets/media/avatars/300-3.jpg')}}" />
                                                                    </div>
                ...
                <tbody>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">
                                        <img src="{{asset('themes/metronic/assets/media/stock/600x600/img-49.jpg')}}" class="" alt=""/>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">
                                        <img src="{{asset('themes/metronic/assets/media/stock/600x600/img-40.jpg')}}" class="" alt=""/>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">
                                        <img src="{{asset('themes/metronic/assets/media/stock/600x600/img-39.jpg')}}" class="" alt=""/>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">
                                        <img src="{{asset('themes/metronic/assets/media/stock/600x600/img-47.jpg')}}" class="" alt=""/>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-50px me-3">
                                        <img src="{{asset('themes/metronic/assets/media/stock/600x600/img-48.jpg')}}" class="" alt=""/>
                                    </div>
