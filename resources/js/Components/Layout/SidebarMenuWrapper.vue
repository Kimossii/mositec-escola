...
const dashboards = {
    items: [
        { href: 'index-2.html', title: 'Default', active: true },
...
const userManagementGroups = [
    {
        title: 'Users',
        items: [
            { href: 'apps/user-management/users/list.html', title: 'Users List' },
            { href: 'apps/user-management/users/view.html', title: 'View User' },
        ],
    },
    {
        title: 'Roles',
