 ...
 * @property {boolean} [isAdministrador] - placeholder só de frontend; "Administrador" não é
 *   um tipo_pessoa no banco, deve vir de roles/permissoes (módulo Permissao) quando existir
 */
...
export const usuariosMock = [
    { id: 1, name: 'Emma Smith', email: 'smith@kpmg.com', avatar: '/themes/metronic/assets/media/avatars/300-6.jpg', matricula: '20240001', estado: ESTADO.ATIVO, tipo_pessoa: TIPO_PESSOA.FUNCIONARIO, ultimo_acesso: 'Yesterday', created_at: '20 Dec 2023, 10:10 pm', isAdministrador: true },
    ...
    { id: 8, name: 'Neil Owen', email: 'owen.neil@gmail.com', avatar: null, avatarColor: 'primary', matricula: '20240008', estado: ESTADO.ATIVO, tipo_pessoa: TIPO_PESSOA.FUNCIONARIO, ultimo_acesso: '20 mins ago', created_at: '22 Sep 2023, 6:05 pm', isAdministrador: true },
